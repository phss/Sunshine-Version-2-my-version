...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor existingLocation = contentResolver.query(WeatherContract.LocationEntry.CONTENT_URI,
                null,
                WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?",
                new String[]{locationSetting},
                null);
        if (existingLocation.moveToFirst()) {
            int idIndex = existingLocation.getColumnIndex(WeatherContract.LocationEntry._ID);
            long locationId = existingLocation.getLong(idIndex);
